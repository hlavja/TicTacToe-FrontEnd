...
export const APIS = [AccountResourceService, FriendResourceService, GameResourceService, LobbyResourceService, UserJwtControllerService, UserResourceService, UserSpecificService];
